...
export default function Footer() {
  return (
    <footer className='relative bg-background px-4 py-12 overflow-hidden'>
      {/* Blurred circles */}
      <div className='absolute top-0 left-0 w-[800px] h-[800px] -translate-x-1/2 bg-orange/10 rounded-full blur-[100px]' />
      <div className='absolute bottom-0 right-0 w-[400px] h-[400px] translate-x-1/4 bg-orange/10 rounded-full blur-[100px]' />
          ...
          <div className='space-y-6'>
            ...
            <div className='space-y-2'>
              <h3 className='font-lora uppercase font-base relative pb-2'>
                OPEN HOURS
                <div className='absolute left-0  bottom-0 h-0.5 w-14 bg-orange' />
              </h3>
              <p className='text-grey font-roboto text-base'>
                Monday - Saturday : 10 AM - 07 PM
              </p>
            </div>
            <SocialButtons className='flex items-start' />
          </div>
