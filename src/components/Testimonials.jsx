...
const testimonials = [
  {
    ...
    author: "Марія Васюник-Кулієва",
    title:
      "Головний спеціаліст відділу дошкільної, загальної середньої і позашкільної освіти управління освіти та інновацій департаменту освіти і науки Львівської обласної державної адміністрації.",
    image: "/person-svg.png",
  },
  {
    id: 2,
    quote:
      ...
      <div className='max-w-7xl mx-auto px-0 md:px-4 pt-24  md:pt-32 pb-28 md:pb-12 relative'>
        ...
        <div className='mt-5 flex items-center justify-center gap-4'>
          <button
            ...
            className='p-2 text-white hoverOpacity-70 transitionOpacity'
